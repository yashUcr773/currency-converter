      ...
      <CardContent className="relative z-10 p-2.5 pt-1 sm:p-3 sm:pt-1 flex-1 flex flex-col justify-end">
        ...
        <div className="relative">
          ...
          <Input
            ...
            disabled={disabled}
            className="pl-8 sm:pl-10 pr-3 sm:pr-4 text-base sm:text-lg font-bold h-10 sm:h-12 bg-slate-50/80 border-2 border-slate-200 focus:border-blue-400 focus:ring-4 focus:ring-blue-400/20 transition-all duration-200 text-slate-800 rounded-lg sm:rounded-xl touch-manipulation"
            placeholder="0"
          />
        </div>
      </CardContent>
